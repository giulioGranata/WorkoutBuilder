  ...
  ({ className, align = "end", children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        tabIndex={-1}
        className={cn(
          "absolute top-full z-50 mt-2 min-w-[12rem] rounded-xl border border-[--border] bg-[--card] p-1 text-sm text-[--text-primary] shadow-[--shadow-card] outline-none backdrop-blur",
          alignmentClass,
          className,
        )}
...
export const dropdownMenuItemClass =
  "flex w-full select-none items-center rounded-lg px-3 py-2 text-sm text-[--text-secondary] transition-colors hover:bg-[--card-light] hover:text-[--text-primary] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--ring]";

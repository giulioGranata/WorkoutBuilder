...
import { WorkoutFormData, Workout } from "@/lib/types";
import { generateWorkout } from "@/lib/generator";
import { Settings, Play } from "lucide-react";

const formSchema = z.object({
  ftp: z.number().min(50, "FTP must be at least 50 watts").max(500, "FTP must be at most 500 watts"),
  durationMin: z.number().min(20, "Duration must be at least 20 minutes").max(180, "Duration must be at most 180 minutes"),
  type: z.enum(["recovery", "endurance", "tempo", "threshold", "vo2max", "anaerobic"]),
...
export function WorkoutForm({ onWorkoutGenerated }: WorkoutFormProps) {
  ...
  return (
    <div className="bg-gray-850 rounded-xl border border-gray-700 p-6">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6" data-testid="workout-form">
          {/* FTP Input */}
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <p className="text-xs text-gray-500">Your maximum sustainable power for 1 hour</p>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value} data-testid="select-workout-type">
                  <FormControl>
                  ...
                  <SelectContent className="bg-gray-700 border border-gray-600">
                    <SelectItem value="recovery" className="text-white hover:bg-gray-600">Recovery (50-60% FTP)</SelectItem>
                    <SelectItem value="endurance" className="text-white hover:bg-gray-600">Endurance (65-75% FTP)</SelectItem>
                    <SelectItem value="tempo" className="text-white hover:bg-gray-600">Tempo (76-90% FTP)</SelectItem>
                    <SelectItem value="threshold" className="text-white hover:bg-gray-600">Threshold (95-105% FTP)</SelectItem>
                    <SelectItem value="vo2max" className="text-white hover:bg-gray-600">VO2max (110-120% FTP)</SelectItem>
                    <SelectItem value="anaerobic" className="text-white hover:bg-gray-600">Anaerobic (125-150% FTP)</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              </FormItem>
                  ...
                  >
                    <div className="relative">
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-400 peer-checked:text-emerald-100">-5% FTP</div>
                      </Label>
                    </div>
                    <div className="relative">
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-400 peer-checked:text-emerald-100">Base FTP</div>
                      </Label>
                    </div>
                    <div className="relative">
